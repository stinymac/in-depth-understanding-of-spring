 ...
 */
public class SpringAPIConstructorDependencyInjection {
    ...
    public static void main(String[] args) {
        ...
        // 注册BeanDefinition
        applicationContext.registerBeanDefinition("userHolder",buildPersonHolderBeanDefinition());
    ...
    public static BeanDefinition buildPersonHolderBeanDefinition(){
        BeanDefinitionBuilder beanDefinitionBuilder = BeanDefinitionBuilder.genericBeanDefinition(PersonHolder.class);
        beanDefinitionBuilder.addConstructorArgReference("person");
